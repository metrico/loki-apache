...
[Loki Releases](https://github.com/metrico/loki-apache/releases) on GitHub.
...
```shell
jb install github.com/metrico/loki-apache-canary/production/ksonnet/loki-canary
```
...
$ git clone https://github.com/metrico/loki-apache
