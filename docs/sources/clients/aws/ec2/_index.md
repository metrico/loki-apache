...
curl -O -L "https://github.com/metrico/loki-apache/releases/download/v2.0.0/promtail-linux-amd64.zip"
...
[final config]: https://github.com/metrico/loki-apache/blob/master/docs/sources/clients/aws/ec2/promtail-ec2-final.yaml
