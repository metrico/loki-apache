...
1. *Without creating a tag*, create a commit based on your changes and open a PR
   ...
   1. Until [852](https://github.com/metrico/loki-apache/issues/852) is fixed, updating
...
1. Go to the [GitHub releases page](https://github.com/metrico/loki-apache/releases)
