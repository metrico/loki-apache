...
Loki uses [GitHub](https://github.com/metrico/loki-apache) to manage reviews of pull requests:
...
```bash
$ git clone https://github.com/metrico/loki-apache.git $GOPATH/src/github.com/metrico/loki-apache
...
Note that if you downloaded Loki using `go get`, the message `package github.com/metrico/loki-apache: no Go files in /go/src/github.com/metrico/loki-apache`
